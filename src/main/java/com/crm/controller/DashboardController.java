...
public class DashboardController {
    ...
    public String dashboard(Model model, @AuthenticationPrincipal UserDetails userDetails) {
        ...
        model.addAttribute("inactiveClients", clientService.countByStatus(com.crm.entity.Client.Status.INACTIVE));
        model.addAttribute("lostClients", clientService.countByStatus(com.crm.entity.Client.Status.LOST));
        ...
        model.addAttribute("processingOrders", orderService.countByStatus(com.crm.entity.Order.Status.PROCESSING));
        model.addAttribute("shippedOrders", orderService.countByStatus(com.crm.entity.Order.Status.SHIPPED));
        model.addAttribute("deliveredOrders", orderService.countByStatus(com.crm.entity.Order.Status.DELIVERED));
